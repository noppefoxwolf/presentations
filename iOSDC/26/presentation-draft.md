...
<!-- 意図: 比較の起点を決め、条件の変化によってUIに何が起きるかを観察する考え方を示す。 -->

^ 環境の変化を捉えるには、まず比較の起点を決めます。このトークでは小さなiPhoneの縦向き画面を起点にし、そこから条件を変えたときに何が起きるかを見ていきます。
...
^ ここまでで、環境が変わってもユーザーの目的を保つという考え方を整理しました。これを具体的な設計に落とすために、まずUIを何からできているものとして捉えるかを見ていきます。
...
<!-- 意図: 広い画面で単純に引き伸ばすと余白だけが増える問題を示す。 -->
...
^ 異なる文脈で表現を選ぶには、モデルを共有したまま、表示のバリエーションを持たせます。
