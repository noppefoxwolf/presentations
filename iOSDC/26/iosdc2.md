...
^ 今日は、画面サイズや環境が変わっても破綻しないUIの設計を、ニュースの例で段階的に見ていきます。先ほど紹介したニュースを使い、同じモデルが異なる表現へ変化する過程を確認します。
...
^ このトークでは、ニュースという同じ題材を使い、環境に応じてサイズ、配置、情報量、操作方法を変えて表現します。最初はiPhoneの一覧から始め、最後にはiPadやWidget、Apple Watchまで同じモデルを展開します。
