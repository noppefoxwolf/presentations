...
^ iOSDCには2018年から毎年登壇しています。

---

![](2.png)

^ DAWN for Mastodonという、Mastodon向けのアプリを作っています。
^ これまでは技術の話が多かったのですが、最近は「UIをどう環境に合わせるか」を考える時間が増えました。今日はその考え方を共有します。
...
^ iPadOSはウィンドウを扱うOSになり

---

![](7.png)

^ iPhone MirroringやDeviceHubではリサイズも起きます。

---

![](8.png)

^ さらに、複数のシーンを扱うことも前提です。
