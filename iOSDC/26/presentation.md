...
^ そのために、まず目的とコンテキストから、インターフェースを考えます。デザインデータも、その条件での一つの答えとして見ると、別の条件で必要な姿を考えやすくなります。
...
^ そう考えると、どれだけコンテキストの組み合わせを考慮できるかが大事になります。
^ 全部を自分で経験することはできません。だからこそ、自分とは違う状況にいるユーザーの声を聞くことが大切だと思います。
...
^ 同じ構造で対応できる範囲と、切り替えるべき境界を見極める。
^ そのための私なりの判断基準を今日は紹介しました。以上になります。
