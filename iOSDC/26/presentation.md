...
^ そこで、コンテキストに含まれる要素を２つに分けて考えてみます。
...
^ 例えば、iPhoneとMacのように、ある境界を越えるとUIの性質そのものが変わる場合は、構造や表現そのものを切り替えます。
...
- コンテキストの違いが目的に影響を与えるかどうかで判断する

- 例えば
    - iPhoneしかない状況では、カーソル操作のUIは適さない
    - ユーザーの身長は、UIの構造や表現に影響を与えないので、境界はない
