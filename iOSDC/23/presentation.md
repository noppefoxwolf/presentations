...
^ 私は、ビジュアル、インタラクション、フィードバックの3つの要素でUIを見ています。
...
^ 最後にフィードバックについて見ていきます。
^ フィードバックとは、ユーザーが行った操作に対して、アプリがどう反応するかを指します。
...
- 安易に真似しても、本来の思想とは異なる使い方になることもある
  - アプリ内通知にApple PencilのようなHUDを使うと、ユーザーは勘違いしないか？
...
- OSSなどで配布する場合、macOSやtvOSなどの対応も考える
