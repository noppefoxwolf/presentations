...
^ 2018年から毎年iOSDCで発表させていただいています。ありがとうございます。
^ あと、きつねが好きです。
^ ８月頭に、第２子が生まれて２児の父もやっております。
...
^ ユーザーは、iOSという巨大なお作法の上で、アプリを使っています。
^ スクロールの慣性や、タップエリア、アクセシビリティ、アニメーション、文字の大きさ、太さなどなど。
^ これらのお作法を無視して、独自のUIを作ると、ユーザーは違和感を感じてしまいます。
...
^ UIKitやSwiftUIを使えば、ある程度はお作法に乗っ取ったUIを作ることができます。
^ しかし、標準アプリなどが持つ細かなお作法は、頑張って実装していくしかありません。
^ この暗黙のお作法こそ、UIにおけるブラックボックスであり、違和感の正体であるということです。
